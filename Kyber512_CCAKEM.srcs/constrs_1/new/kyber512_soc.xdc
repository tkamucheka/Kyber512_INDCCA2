...
set_output_delay -clock [get_clocks sys_diff_clock_clk_p] -min 1.000 [get_ports -filter { NAME =~  "*GPIO*" && DIRECTION == "OUT" }]
set_output_delay -clock [get_clocks sys_diff_clock_clk_p] -max 2.000 [get_ports -filter { NAME =~  "*GPIO*" && DIRECTION == "OUT" }]
